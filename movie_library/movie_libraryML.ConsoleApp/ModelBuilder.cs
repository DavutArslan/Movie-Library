...
using Movie_libraryML.Model;

namespace Movie_libraryML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\User\Desktop\ml-latest-small\ratings.csv";
        private static string MODEL_FILEPATH = @"C:\Users\User\AppData\Local\Temp\MLVSTools\movie_libraryML\movie_libraryML.Model\MLModel.zip";
